  ...
  return (
    <div className="legal-page">
      ...
      <div className="legal-container">
        ...
        <p className="legal-subtitle">Effective March 18, 2026 &middot; TourLytics and its affiliates</p>
        ...
        <h2 className="legal-h2">KEY TERMS SUMMARY</h2>
            ...
            <p className="legal-p">Who operates TourLytics? TourLytics is operated by TourLytics and its affiliates, a California-based company.</p>
            ...
            <p className="legal-p">Arbitration. Disputes are resolved through binding individual arbitration in California, not through court litigation. You waive the right to participate in class actions. You may opt out of arbitration within thirty (30) days of accepting these Terms.</p>
            ...
            <p className="legal-p">&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot; means TourLytics and its affiliates, with its principal place of business in the State of California.</p>
            ...
            <p className="legal-p">&quot;Platform&quot; or &quot;Service&quot; means the TourLytics software-as-a-service platform accessible at tourlytics.ai (formerly tour-lytics.com), including all related tools, features, APIs, mobile applications, and updates thereto.</p>
            ...
            <p className="legal-caps">ANY DISPUTE, CLAIM, OR CONTROVERSY ARISING OUT OF OR RELATING TO THESE TERMS OR THE BREACH, TERMINATION, ENFORCEMENT, INTERPRETATION, OR VALIDITY THEREOF, INCLUDING THE DETERMINATION OF THE SCOPE OR APPLICABILITY OF THIS AGREEMENT TO ARBITRATE (COLLECTIVELY, &quot;DISPUTES&quot;), SHALL BE DETERMINED BY BINDING ARBITRATION IN THE STATE OF CALIFORNIA BEFORE A SINGLE ARBITRATOR. THE ARBITRATION SHALL BE ADMINISTERED BY JAMS PURSUANT TO ITS COMPREHENSIVE ARBITRATION RULES AND PROCEDURES OR, IF JAMS IS UNAVAILABLE, BY THE AMERICAN ARBITRATION ASSOCIATION (&quot;AAA&quot;) PURSUANT TO ITS COMMERCIAL ARBITRATION RULES. JUDGMENT ON THE AWARD MAY BE ENTERED IN ANY COURT HAVING JURISDICTION.</p>
            ...
            <p className="legal-p">TourLytics and its affiliates</p>
            ...
            <p className="legal-p">The TourLytics Team</p>
